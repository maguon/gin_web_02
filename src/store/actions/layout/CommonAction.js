...
export const getCategoryList = () => async (dispatch) => {
    try {
        ...
        if (res.success) {
            ...
            console.log('获取商品分类列表失败', res.msg, 'warning');
        }
    } catch (err) {
...
export const getCategorySubList = (categoryId) => async (dispatch) => {
    try {
        ...
        if (res.success) {
            ...
            console.log('获取商品子类列表失败', res.msg, 'warning');
        }
    } catch (err) {
        console.log('操作失败', err.message, 'error');
    }
...
export const getBrandList = () => async (dispatch) => {
    try {
        ...
        if (res.success) {
            ...
            console.log('获取品牌列表失败', res.msg, 'warning');
        }
    } catch (err) {
        console.log('操作失败', err.message, 'error');
    }
...
export const getBrandModelList = (brandId) => async (dispatch) => {
    try {
        ...
        if (res.success) {
            ...
            console.log('获取品牌型号列表失败', res.msg, 'warning');
        }
    } catch (err) {
        console.log('操作失败', err.message, 'error');
    }
...
export const getProductList = (queryParams) => async (dispatch) => {
    try {
        ...
        if (res.success) {
            ...
            console.log('获取商品列表失败', res.msg, 'warning');
        }
    } catch (err) {
        console.log('操作失败', err.message, 'error');
    }
...
export const getStorageList = () => async (dispatch) => {
    try {
        ...
        if (res.success) {
            ...
            console.log('获取仓库列表失败', res.msg, 'warning');
        }
    } catch (err) {
        console.log('操作失败', err.message, 'error');
    }
...
export const getStorageAreaList = (storageId) => async (dispatch) => {
    try {
        ...
        if (res.success) {
            ...
            console.log('获取仓库分区列表失败', res.msg, 'warning');
        }
    } catch (err) {
        console.log('操作失败', err.message, 'error');
    }
...
export const getSupplierList = () => async (dispatch) => {
    try {
        ...
        if (res.success) {
            ...
            console.log('获取供应商列表失败', res.msg, 'warning');
        }
    } catch (err) {
        console.log('操作失败', err.message, 'error');
    }
...
export const getClientList = () =>async (dispatch) => {
    try {
        ...
        if (res.success) {
            ...
            console.log('获取客户信息列表失败', res.msg, 'warning');
        }
    } catch (err) {
        console.log('操作失败', err.message, 'error');
    }
...
export const getClientAgentList = () =>async (dispatch) => {
    try {
        ...
        if (res.success) {
            ...
            console.log('获取客户集群信息列表失败', res.msg, 'warning');
        }
    } catch (err) {
        console.log('操作失败', err.message, 'error');
    }
...
export const getSaleServiceList = () =>async (dispatch) => {
    try {
        ...
        if (res.success) {
            ...
            console.log('获取服务项目列表失败', res.msg, 'warning');
        }
    } catch (err) {
        console.log('操作失败', err.message, 'error');
    }
...
export const getUserList = () =>async (dispatch) => {
    try {
        ...
        if (res.success) {
            ...
            console.log('获取用户列表失败', res.msg, 'warning');
        }
    } catch (err) {
        console.log('操作失败', err.message, 'error');
    }
